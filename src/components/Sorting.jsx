		...
		<div className="max-w-[1640px] mx-auto p-2 border border-custom-orange">
			...
			<div className="flex flex-col">
				<div className="flex items-center mb-2">
					<input type="radio" id="ascending" name="sortOrder" value="ascending" checked={state.isAsc} onChange={() => handleChangeSortOrder(true)} />
				...
				<div className="flex items-center">
					<input type="radio" id="descending" name="sortOrder" value="descending" checked={!state.isAsc} onChange={() => handleChangeSortOrder(false)} />
